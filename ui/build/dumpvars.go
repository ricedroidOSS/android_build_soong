...
var BannerVars = []string{
	...
	"RICE_PACKAGE_TYPE",
	"LINEAGE_DEVICE",
	"TARGET_BUILD_APERTURE_CAMERA",
	"TARGET_BUILD_GRAPHENEOS_CAMERA",
	"TARGET_ENABLE_PIXEL_GBOARD_PADDINGS",
	"TARGET_HAS_UDFPS",
	"TARGET_KERNEL_OPTIONAL_LD",
	"TARGET_SUPPORTS_NEXT_GEN_ASSISTANT",
	"TARGET_USE_GOOGLE_TELEPHONY",
	"TARGET_USE_PIXEL_FINGERPRINT",
	"TARGET_ARCH",
	"TARGET_ARCH_VARIANT",
	"TARGET_CPU_VARIANT",
	"TARGET_2ND_ARCH",
